    ...
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
          ...
          QuickUpload is your fastest way to share files — making it simple and secure to upload and download your documents, photos, and videos. We make moving your data easy and instant.</p>
        </div>
